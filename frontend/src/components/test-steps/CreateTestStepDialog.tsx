...
export default function CreateTestStepDialog({
  ...
  const handleSubmit =
    async (
      ...
      const trimmedTestStepId =
        testStepId.trim();

      const trimmedAction =
        action.trim();

      if (!trimmedTestStepId) {
        setError(
          'Test Step ID is required.',
        );
      ...
      if (
        trimmedTestStepId.length >
        50
      ) {
        setError(
          'Test Step ID must not exceed 50 characters.',
        );
        ...
        >
          ...
          >
            ...
            <TextField
              ...
              helperText="Test Step ID must be unique across TestForge."
              placeholder="Example: STEP-LOGIN-001"
              onChange={(
                event,
              ) =>
                setTestStepId(
            ...
            <TextField
              ...
              helperText="Step Order must be unique within this Test Case."
              onChange={(
                event,
              ) =>
                setStepOrder(
