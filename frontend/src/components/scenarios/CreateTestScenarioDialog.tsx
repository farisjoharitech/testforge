...
export default function CreateTestScenarioDialog({
  ...
  const handleSubmit =
      async (
        ...
        if (
            trimmedScenarioId.length >
            50
        ) {
          setError(
              'Scenario ID must not exceed 50 characters.',
          );
          ...
          >
            ...
            >
              ...
              <TextField
                  ...
                  placeholder="Example: SCN-LOGIN-001"
                  helperText="Scenario ID must be unique."
                  onChange={(
                      event,
                  ) =>
                      setScenarioId(
